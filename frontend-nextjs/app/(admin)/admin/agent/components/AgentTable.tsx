      ...
      <div className="w-full overflow-x-auto">
        <div className="min-w-230">
          ...
          <div className="flex items-center px-6 py-4 bg-slate-50 border-b border-slate-200 text-xs font-bold text-slate-500 uppercase tracking-wider">
            ...
            <div className="w-40 shrink-0">Email Verified</div>
          ...
          {!loading && agents.length > 0 && (
            <div className="divide-y divide-slate-100">
              {agents.map((agent, idx) => {
                ...
                const isVerified = agent.is_email_verified;
                ...
                return (
                  ...
                  >
                    ...
                    {/* 🟢 ရိုးရိုးရှင်းရှင်းနှင့် သပ်ရပ်လှပသော Email Verified Column */}
                    <div className="w-40 shrink-0">
                      {isVerified ? (
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-blue-50 text-blue-700 border border-blue-200/80 shadow-3xs">
                          <ShieldCheck className="w-3.5 h-3.5 text-blue-500" />
                          Verified
                        </span>
                      ) : (
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-rose-50 text-rose-700 border border-rose-100 shadow-3xs">
